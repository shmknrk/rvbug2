...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { aclk_i }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { areset_ni }]; #IO_L16P_T2_35 Sch=ck_rst
