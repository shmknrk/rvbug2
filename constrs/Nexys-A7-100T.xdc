...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { aclk_i }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { aclk_i }]; # 100 MHz

## Pblock
#create_pblock pblock_0;
#resize_pblock       [get_pblocks pblock_0] -add {CLOCKREGION_X0Y0};
#add_cells_to_pblock [get_pblocks pblock_0] [get_cells -quiet [list {m_axil_rvcore0}]];
#add_cells_to_pblock [get_pblocks pblock_0] [get_cells -quiet [list {axi_interconnect0}]];
#add_cells_to_pblock [get_pblocks pblock_0] [get_cells -quiet [list {s_axil_ram0}]];
#add_cells_to_pblock [get_pblocks pblock_0] [get_cells -quiet [list {s_axil_uart0}]];
...
## CPU Reset Button
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { areset_ni }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
